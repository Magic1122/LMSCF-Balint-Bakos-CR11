...
<div class="card card-body bg-light mt-5">
    <h2>Edit Animal</h2>
    <p>Edit a pet with this form</p>
    <form action="<?php echo URLROOT;?>/animals/edit/<?= $data['id']; ?>" method="POST">
        ...
        <div class="form-group">
            ...
            class="form-control form-control-lg <?php echo (!empty($data['breed_err'])) ? 'is-invalid' : ''; ?>">
                ...
                ?>
                <script type="text/javascript">
                document.getElementById('breed').value = "<?php echo $data['breed'] ;?>";
                </script>
                </select>
            <span class="invalid-feedback"><?php echo $data['breed_err']; ?></span>
            <a href="<?php echo URLROOT;?>/animals/addbreed/<?= $data['id']; ?>" class="btn btn-success mt-3">Add Breed</a>
        </div>
        <div class="form-group">
            ...
            class="form-control form-control-lg <?php echo (!empty($data['location_err'])) ? 'is-invalid' : ''; ?>">
               ...
               <script type="text/javascript">
                document.getElementById('location').value = "<?php echo $data['location'] ;?>";
            </script>
            <span class="invalid-feedback"><?php echo $data['location_err']; ?></span>
            <a href="<?php echo URLROOT;?>/animals/addlocation/<?= $data['id']; ?>" class="btn btn-success mt-3">Add Location</a>
        </div>
